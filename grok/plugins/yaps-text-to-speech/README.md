# Yaps Text to Speech for Grok Build

Read text aloud and create local WAV narration with Yaps voices. Text-to-speech for scripts, documents, and voice-overs.
