# Yaps Translation for Grok Build

Translate text, Markdown, and SRT subtitles privately with local Yaps translation models. Preserve subtitle timing and create separate translated files.
