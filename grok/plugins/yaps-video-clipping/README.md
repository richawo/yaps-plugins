# Yaps Auto Cut for Grok Build

Remove dead air and long pauses from local videos with Yaps Auto Cut. Review and tune the cut plan, then export a separate tightened MP4.
...
Yaps 2.3.124 is only the credential-free account-check minimum. This workflow requires 2.3.848 or newer. No API key is required.
