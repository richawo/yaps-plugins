# Yaps Transcription for Grok Build

Transcribe local audio and video files into plain text with Yaps. Private speech-to-text for podcasts, interviews, recordings, and voice memos.
