# Yaps Audio Cleaner for Grok Build

Reduce noise, hiss, and static in speech recordings with local Yaps Audio Cleaner. Export a separate cleaned WAV for podcasts, interviews, and voice notes.
