# Yaps SRT Generator for Grok Build

Generate timestamped SRT subtitle files from local audio or video with Yaps. Create separate subtitles without changing the source recording.
