# Yaps Translation for Claude Code
...
- "Translate this SRT file into Spanish while preserving the timing."
- "Translate this Markdown document into German and keep the original."
