# Yaps SRT Generator for Claude Code
...
- "Create an SRT subtitle file for this video."
- "Generate timed subtitles from this audio recording."
- "Save English subtitles beside this product demo without changing the video."
