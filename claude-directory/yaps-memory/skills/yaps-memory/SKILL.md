...
If vault_status reports an engine discovery problem, open Yaps on the same computer and retry. Offer [Download Yaps](https://yaps.ai/download) if setup is incomplete. A remote session cannot reach another computer's local vault. Do not claim Yaps is uninstalled solely because it is unreachable.
