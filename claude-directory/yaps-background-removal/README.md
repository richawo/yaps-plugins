# Yaps Background Removal for Claude Code

Remove an image background with Yaps. Save a transparent PNG, solid background, or outlined sticker. New users: install Yaps and sign in.
...
- "Remove this photo's background and save a transparent PNG."
- "Place this product photo on a white background."
- "Make an outlined sticker from this existing image."
