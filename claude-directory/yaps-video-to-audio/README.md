# Yaps Video to Audio for Claude Code
...
- "Extract the sound from this video as an MP3."
- "Save this interview video's audio as a separate WAV."
- "Convert the soundtrack of this video to M4A without changing the source."
