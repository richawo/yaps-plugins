...
Return a link to the captioned video. A saved caption project is not a completed video export. Use the yaps-transcription skill for plain text and srt-generator for a separate `.srt` file.
