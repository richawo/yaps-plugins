# Yaps Audio Cleaner for Claude Code
...
- "Reduce background noise in this voice recording."
- "Clean the hiss from this interview and save a separate WAV."
- "Check whether Yaps is ready to clean this recording before processing it."
